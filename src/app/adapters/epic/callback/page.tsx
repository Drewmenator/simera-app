  ...
  useEffect(() => {
    ...
    async function exchange() {
      try {
        ...
        const res = await fetch(`${BASE}/adapters/epic/callback`, {
          method: "POST",
          headers: {
        ...
        setStatus("success");
        setMessage("Epic connected successfully! Pulling your FHIR data now.");
      ...
      <div style={{
        ...
        {status === "processing" && (
          <>
            ...
            <p style={{ fontSize: 16, fontWeight: 600, color: "#0b2734" }}>Connecting to Epic…</p>
            <p style={{ fontSize: 13, color: "#5c747e", marginTop: 6 }}>Exchanging credentials and syncing your FHIR data.</p>
          </>
        )}
        {status === "success" && (
          <>
